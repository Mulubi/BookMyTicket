...
Revision ID: 9e32c9497df1
Revises: d263e17c64c3
Create Date: 2023-03-07 05:27:36.119360
...
revision = '9e32c9497df1'
down_revision = 'd263e17c64c3'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('patient_id', mysql.VARCHAR(length=60), nullable=True),
    sa.ForeignKeyConstraint(['patient_id'], ['patients.id'], name='theatre_patient_ibfk_2'),
    sa.ForeignKeyConstraint(['theatre_id'], ['theatres.id'], name='theatre_patient_ibfk_1'),
    ...
    sa.ForeignKeyConstraint(['patient_id'], ['patients.id'], name='patient_booking_ibfk_1'),
    sa.ForeignKeyConstraint(['procedure_id'], ['procedures.id'], name='patient_booking_ibfk_2'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    )
